...
export const metadata = buildMetadata({
  title: "Turismo",
  description:
    "Descubre los atractivos turísticos de Arivechi: Kiosco Morisco, Templo de Santa Rosalía, Cerro de las Conchas, Río Sahuaripa, Cerro de los Pilares y la Fiesta de Santa Rosalía.",
  path: "/turismo",
});
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 md:py-24">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-2xl text-base text-[var(--color-cream)]/90 md:text-lg">
              Patrimonio histórico, paisajes serranos, áreas naturales protegidas y la
              tradición ópata en cada rincón. Explora los seis atractivos más
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-14 sm:px-6 md:grid-cols-2 md:py-20">
          ...
          <div className="rounded-2xl border border-[var(--color-border)] bg-white p-6 shadow-[var(--shadow-card)] md:p-8">
            ...
            <p className="mt-4 text-sm text-[var(--color-text-secondary)]">
              Las y los artesanos de Arivechi mantienen vivas las técnicas
