...
import { getCabildo, getNoticiasRecientes, getPortadaHistoria, getInformacionImportante } from "@/lib/content";
...
export default async function HomePage() {
  ...
  const [noticiasRecientes, portadaUrl, cabildo, infoImportante] =
    await Promise.all([
