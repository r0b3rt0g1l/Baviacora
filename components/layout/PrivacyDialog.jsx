          ...
          <Dialog.Portal forceMount>
            ...
            <Dialog.Content asChild>
              <motion.div
                ...
                className="glass-panel fixed left-1/2 top-1/2 z-50 flex max-h-[85vh] w-[min(92vw,640px)] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-2xl"
              >
                <div className="flex items-start gap-4 border-b border-[var(--color-border)] px-6 py-5 text-[var(--color-text)]">
                  ...
                  <Dialog.Close asChild>
                    <button
                      ...
                      className="-mt-1 inline-flex h-11 w-11 items-center justify-center rounded-full text-[var(--color-text-muted)] transition hover:bg-[var(--color-bg)] hover:text-[var(--color-text)]"
                    >
                ...
                <div className="flex flex-col-reverse items-stretch gap-3 border-t border-[var(--color-border)] bg-[var(--color-bg)] px-6 py-4 sm:flex-row sm:items-center sm:justify-end">
                  ...
                  <Dialog.Close asChild>
                    <button
                      type="button"
                      className="rounded-md bg-[var(--color-dorado)] px-4 py-2 text-sm font-semibold text-[var(--color-text)] transition hover:opacity-90"
                    >
                      Entendido
                    </button>
                  </Dialog.Close>
