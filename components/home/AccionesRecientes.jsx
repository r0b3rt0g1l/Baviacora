            ...
            return (
              ...
              >
                <Link
                  ...
                  className="flex h-full flex-col overflow-hidden rounded-2xl border border-[var(--color-dorado)]/30 bg-white shadow-[0_10px_30px_-10px_rgba(31,56,19,0.5)] transition duration-300 hover:-translate-y-1 hover:border-[var(--color-dorado)]/70 hover:shadow-[0_18px_40px_-12px_rgba(31,56,19,0.6)]"
                >
