      ...
      <div className="flex flex-col overflow-hidden rounded-2xl border border-[var(--color-border)] bg-white shadow-[var(--shadow-card)] sm:flex-row">
        ...
        <div className="flex flex-1 flex-col gap-1 p-4">
          ...
          <Link
            ...
            className="glass-light group mt-3 inline-flex w-fit items-center gap-2 rounded-full px-4 py-2 text-sm font-semibold text-[var(--color-text)] transition-all duration-200 hover:scale-105"
          >
            Conoce al cabildo
            <ArrowRight
              aria-hidden="true"
