...
export const heroImages = [
  {
    id: "bienvenida",
    src: "/images/baviacora/hero-baviacora.jpg",
    alt: "Vista del municipio de Baviácora, Sonora",
    credit: "H. Ayuntamiento de Baviácora",
  },
  {
    id: "patrimonio",
  ...
  {
    id: "kiosco",
    src: "/images/baviacora/turismo-baviacora.jpg",
    alt: "Vista del municipio de Baviácora, Sonora",
    credit: "H. Ayuntamiento de Baviácora",
  },
  {
...
export const noticiaPlaceholderImages = {
  ...
  default: img(
    ...
    SM,
    "Imagen institucional del Gobierno Municipal de Baviácora",
  ),
};
